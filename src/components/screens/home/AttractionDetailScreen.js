...
class AttractionDetailScreen extends React.Component {
    ...
    render(){
        ...
        const engDescription = navigation.getParam('engDescription', 'no english description');
                            ...
                            <View rkCardContent>
                                <View>
                                    <Text>
                                        ...
                                        {"\n"}
                                        {engDescription === "" ? "No description provided." : engDescription}
                                        {"\n"}
                                    </Text>
                                </View>
                            </View>
