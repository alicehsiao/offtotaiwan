...
class BikeCard extends React.Component {
    render(){
        ...
        return (
            <TouchableOpacity delayPressIn={50} onPress={() => NavigationService.navigate('BikeDetails', {...this.props.place, updateHeart: this.props.updateHeart, isLoggedIn: this.props.isLoggedIn})}>
                <Card>
                    <CardItem>
                        <Left>
